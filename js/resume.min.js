...
/***/ function(module, exports, __webpack_require__) {
	...
	var ZH = __webpack_require__(164);


	var InfoHeader = React.createClass({displayName: "InfoHeader",
	  render: function () {
	    return (
	      React.createElement("section", {className: "info-header"}, 
	    ...
	    var children = this.props.data.map(function (d, i) {
	      return (
	        React.createElement("li", {key: i}, 
	          React.createElement("span", {className: "school"}, d.name, ", "), 
	          React.createElement("span", {className: "program"}, d.program, ", "), 
	          React.createElement("span", {className: "dates"}, d.start_date, " ~ ", d.end_date)
	        )
	      );
	    });
	  ...
	  render: function () {
	    ...
	    var children = this.props.data.map(function (w, i) {
	      var descriptions = w.descriptions.map(function (d, j) {
	        return (
	          React.createElement("li", {key: j}, d)
	        );
	      });
	      ...
	      return (
	        React.createElement("li", {key: i}, 
	          React.createElement("div", {className: "info"}, 
	            React.createElement("strong", {className: "employer"}, w.employer), React.createElement("br", null), 
	            React.createElement("strong", {className: "position"}, w.position), React.createElement("br", null), 
	            React.createElement("span", {className: "dates"}, w.start_date, " ~ ", w.end_date)
	          ), 
	          React.createElement("ul", null, 
	            descriptions
	          )
	    ...
	    return (
	      React.createElement("section", {className: "work-experience"}, 
	        React.createElement("h2", null, title), 
	        React.createElement("ul", null, 
	          children
	        )
	  ...
	  render: function () {
	    ...
	    return (
	      React.createElement("footer", null, 
	        React.createElement("p", null, "© 2012 - 2015 | ", React.createElement("a", {onClick: this.props.toggleLang}, lang))
	      )
	    );
	  }
	});
	  ...
	  render: function () {
	    ...
	    return (
	      React.createElement("div", {className: "resume"}, 
	        React.createElement(InfoHeader, {lang: this.state.lang, name: data.name, email: data.email}), 
	        React.createElement(Education, {lang: this.state.lang, data: data.education}), 
	        React.createElement(WorkExperience, {lang: this.state.lang, data: data.work_experience}), 
	        React.createElement(Skills, {lang: this.state.lang, data: data.skills}), 
	        React.createElement(Footer, {lang: this.state.lang, toggleLang: this._toggleLang})
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		"education": [
			{
				...
				"program": "BS, Biology/Psychology",
				"start_date": "2004-09",
				"end_date": "2008-06"
			},
			{
				"name": "East China Normal University",
				"program": "Master, Psychology Science & Human Behavior",
				"start_date": "2008-09",
				"end_date": "2011-06"
			}
		],
		"work_experience": [
			{
				"employer": "Waterville Inc.",
				"position": "a startup company",
				"start_date": "2009-05",
				"end_date": "2012-06",
				"descriptions": [
					"1. assessment and model based consulting/solution for talent hiring and management",
					"2. led a team of 4 engineers",
					"3. carried out on-campus recruiting for fortune global 500 companies; 3,000 online users in an hour",
					"4. Windows/IIS/SQLServer/ASP.NET dev and op"
				]
			},
			{
				"employer": "Magic Point",
				"position": "js engineer",
				"start_date": "2012-07",
				"end_date": "2014-11",
				"descriptions": [
					"1. data reports friendly and customizable for K-12 assessment statistics. http://www.emetric.net",
					"2. single page web app. http://www.nevadareportcard.com/di/",
					"3. web/mobile, front/back, js/node/python/C#"
				]
			},
			{
				"employer": "NextTao",
		...
		"skills": [
			{
				"name": "Summary",
				"descriptions": [
					"1. a professional frontend engineer",
					"2. thorough and detailed personality",
					"3. highly accomplished, quick learner, impressive hands-on knowledge"
				]
			},
			{
				"name": "IT Skills",
				"descriptions": [
					"1. Web/Mobile, Front/Back, JS/Python/Haskell",
					"2. C#, .NET, PDF",
					"3. Docker/Debian/Nginx/Mysql"
				]
			},
			{
				"name": "Interests",
				"descriptions": [
					"Education, Medical, Sports"
				]
			}
		]
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCSSTransitionGroup = __webpack_require__(7);
	var ReactTransitionGroup = __webpack_require__(8);
	...
	if ("production" !== process.env.NODE_ENV) {
	  React.addons.Perf = __webpack_require__(13);
	  React.addons.TestUtils = __webpack_require__(14);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactLink = __webpack_require__(16);
	var ReactStateSetters = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5);
	var ReactTransitionChildMapping = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDefaultPerfAnalysis = __webpack_require__(54);
	var ReactMount = __webpack_require__(32);
	var ReactPerf = __webpack_require__(34);
	...
	function inject() {
	  ...
	  if ("production" !== process.env.NODE_ENV) {
	    ...
	    if ((/[?&]react_perf\b/).test(url)) {
	      var ReactDefaultPerf = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CSSCore = __webpack_require__(108);
	var ReactTransitionEvents = __webpack_require__(109);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createArrayFrom = __webpack_require__(162);
	var getMarkupWrap = __webpack_require__(161);
	var invariant = __webpack_require__(49);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		"education": [
			{
				"name": "复旦大学",
				"program": "生物科学/心理学，理科学士",
				"start_date": "2004-09",
				"end_date": "2008-06"
			},
			{
				"name": "华东师范大学",
				"program": "应用心理学与人类行为，硕士",
				"start_date": "2008-09",
				"end_date": "2011-06"
			}
		],
		"work_experience": [
			{
				...
				"end_date": "2012-06",
				"descriptions": [
					"1. 基于人格测量模型的人才招聘及管理解决方案",
					"2. 领导4名工程师的开发小组",
					"3. 某500强企业校园招聘项目落地；能同时容纳3000人在线",
					"4. Windows/IIS/SQLServer/ASP.NET开发和运维"
				]
			},
			{
				"employer": "Magic Point",
				...
				"end_date": "2014-11",
				"descriptions": [
					"1. 定制化的K-12测量/成绩统计数据报告. http://www.emetric.net",
					"2. 单页webapp应用. http://www.nevadareportcard.com/di/",
					"3. web/mobile, front/back, js/node/python/C#"
				]
			},
			{
